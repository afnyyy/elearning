    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><?php echo isset($_GET['Edit']) ? 'Edit ' : 'Create New' .' '?>Major</h5>
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" name="is_active" value="<?php echo isset($_GET['Edit']) ? $rowUpdate['is_active'] : '' ?>" required>
